...
__all__ = [ 'OLE_XSIZE_PIXELS', 'OLE_XSIZE_HIMETRIC',
           'OLE_OPTEXCLUSIVE', 'FontEvents', 'FONTNAME', 'Unchecked',
           'Picture', 'OLE_ENABLEDEFAULTBOOL', 'OLE_YSIZE_CONTAINER',
           'IFontDisp', 'OLE_YPOS_HIMETRIC', 'FONTSIZE',
           'OLE_XPOS_HIMETRIC', 'FONTUNDERSCORE', 'IFont', 'Color',
           'VgaColor', 'FONTSTRIKETHROUGH', 'OLE_YSIZE_PIXELS',
           'Default', 'FONTBOLD', 'OLE_XSIZE_CONTAINER',
           'OLE_XPOS_CONTAINER', 'OLE_COLOR', 'OLE_CANCELBOOL',
           'OLE_YPOS_CONTAINER', 'OLE_YSIZE_HIMETRIC', 'IPictureDisp',
           'Checked', 'OLE_TRISTATE', 'StdPicture', 'OLE_XPOS_PIXELS',
           'Gray', 'IPicture', 'OLE_YPOS_PIXELS', 'OLE_HANDLE',
           'FONTITALIC', 'Monochrome', 'LoadPictureConstants', 'Font',
           'IFontEventsDisp', 'StdFont']
from comtypes import _check_version; _check_version('1.1.11', 1536995557.925106)
